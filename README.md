...
WARNING: NEVER USE TO SPREAD MISNFORMATION AND DOXXING! ONLY USE FOR REAL WHISTEBLOWING!

(for while i still builiding this index) there here a list of whistleblowing tools that are useful for anonymous and safe report, protecting the identity from who reported, i hope that will be useful
